...
public class TotalView extends View {
    ...
    public void computeAndSetValue(final int valueOne, final int valueTwo){

        float percentage = ((float)Math.min(valueOne, valueTwo) / (float)Math.max(valueOne, valueTwo));
        setValue( (int)(percentage*100) );
    }

    public void computeAndSetValue(final long valueOne, final long valueTwo){
        float percentage = ((float)Math.min(valueOne, valueTwo) / (float)Math.max(valueOne, valueTwo));
        setValue( (int)(percentage*100) );
    }

    public void computeAndSetValue(final byte valueOne, final byte valueTwo){
        float percentage = ((float)Math.min(valueOne, valueTwo) / (float)Math.max(valueOne, valueTwo));
        setValue( (int)(percentage*100) );
    }

    public void computeAndSetValue(final short valueOne, final short valueTwo){
        float percentage = ((float)Math.min(valueOne, valueTwo) / (float)Math.max(valueOne, valueTwo));
        setValue( (int)(percentage*100) );
    }
