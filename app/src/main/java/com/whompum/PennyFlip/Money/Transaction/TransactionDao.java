...
public interface  TransactionDao {
    ...
    LiveData<List<Transaction>> fetch(@NonNull final String sourceId);
    ...
    LiveData<List<Transaction>> fetch(final int transactionType, final long floor, final long ciel);
